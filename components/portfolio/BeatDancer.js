  ...
  return (
    <div className="h-[100vh] bg-[#ADF1D2]">
      ...
      <header className="text-right mr-10">
        <h1 className="font-bold text-[#6B7FD7] text-8xl">Beat Dancer</h1>
        <span className="font-bold text-slate-400 text-2xl">
          March 24, 2022
        </span>
      </header>

      <div className="pr-[10%] md:pr-0 w-[90%] md:w-[50%] mt-4 md:mt-10 inline-block">
        <VideoPlayer
      ...
      <div className="w-[90%] md:w-[45%] mt-4 md:mt-8 ml-2 md:ml-0 inline-block align-top pl-8">
        <h1 className="font-bold text-[#DE6C83] text-2xl">Technologies Used</h1>
        <div className="mt-2 table">
          ...
          <img
            ...
            alt="MySQL"
            className="w-16 float-left ml-4"
          />
          <img
            src="/images/technologies/CS.png"
            alt="C#"
            className="w-14 float-left ml-4"
          />
          <img
            src="/images/technologies/Unity.png"
            alt="Unity"
            className="w-[6rem] float-left ml-4 pt-1"
          />
        </div>
        <h1 className="mt-2 font-bold text-[#DE6C83] text-2xl">Description</h1>
        <div className="mt-2 w-full">
          <p className="text-[#e7869a] text-xl">
